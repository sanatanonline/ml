...
input_path = 'C:/Users/local/data/IOT/wustl_iiot_2021'
output_path = 'C:/Users/local/data/IOT/output'
...
dummy_y = keras.utils.to_categorical(y_train)
y_valtest = keras.utils.to_categorical(y_valtest)
...
# dummy_test = keras.utils.to_categorical(y_test)
